    ...
    class SqlAdapter
      ...
      def add_references_to_partition_table(*partition_key_values)
        configurator.foreign_keys(*partition_key_values).each do |foreign_key|
          add_foreign_key_custom(partition_table_name(*partition_key_values),
      ...
      def_delegators :connection, :execute, :add_index, :remove_index, :create_schema, :drop_schema, :add_foreign_key_custom,
