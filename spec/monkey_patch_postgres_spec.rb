...
module ActiveRecord::ConnectionAdapters
  ...
  describe "PostgreSQLAdapter" do
    ...
    describe "add_foreign_key_custom" do
      ...
      it "added foreign key constraint" do
        ...
        SQL
        ActiveRecord::Base.connection.add_foreign_key_custom("employees_partitions.temp", :company_id, "companies", :id)
